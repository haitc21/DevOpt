...
## 6.2 Sử dụng Credentil để bảo mật thông tin

- Để bảo mật hơn cho REGISTRY_USER và REGISTRY_PASSWD nên sử dụng Credentil thay vì sử dụng Environment variables
...
- Add Credentil có id là docker_registry_creds
...
## 6.2 Xác nhận khi deploy: Continuous Delivery

- Nên sử dụng trong Production vì khi delpy cần người xác nhận đảm bảo tính đúng đắn
- Ví dụ dưới đây cho phép chờ 5 phút đợi admin vào xác nhận mới deploy
